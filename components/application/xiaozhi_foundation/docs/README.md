...
| Xiaozhi `websocket_task` | 12 KiB, Internal RAM | The upstream WebSocket client default of 4 KiB overflowed while dispatching production protocol/text callbacks. |
