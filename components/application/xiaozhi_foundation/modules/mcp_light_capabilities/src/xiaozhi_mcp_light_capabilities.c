    ...
    esp_mcp_tool_result_t *result)
{
    ...
    static const char json[] =
        ...
        "\"effects\":[\"solid\",\"blink\",\"breath\",\"pulse\",\"rainbow\",\"strobe\",\"heartbeat\",\"candle\",\"sos\",\"lightning\",\"wake_up\",\"sleep_fade\",\"notification\"],"
    ...
    static const char text[] =
        ...
        "effects=solid,blink,breath,pulse,rainbow,strobe,heartbeat,candle,sos,lightning,wake_up,sleep_fade,notification; brightness_percent=0..100. "
