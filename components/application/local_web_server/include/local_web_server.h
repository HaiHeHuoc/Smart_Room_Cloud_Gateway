...
/**
 * @brief Initialize the local, read-only Web frontend.
 *
 ...
 * `sd_card_manager` APIs for copied metadata and does not mount/unmount SD or
 * control Wi-Fi. This task-context API is idempotent after success.
 */
