...
#define AUDIO_DSP_OUTPUT_PEAK_CEILING_PCM16      9000U
#define AUDIO_DSP_PEAK_SOFT_THRESHOLD_PCM16 \
    ((AUDIO_DSP_OUTPUT_PEAK_CEILING_PCM16 * 2U) / 3U)
#define AUDIO_DSP_PEAK_SOFT_RATIO               4
#define AUDIO_DSP_PLAYBACK_VALIDATED_PEAK_PCM16 \
